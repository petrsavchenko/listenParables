(function () {
    ...
    WinJS.Namespace.define("Data", {
        ...
        getPlaylistFromGroup: getPlaylistFromGroup
    });
    
    //WinJS.xhr({ url: "data/data.txt" }).done(function (xhr) {
    ...
    function createFileData() {
        Windows.ApplicationModel.Package.current.installedLocation.getFolderAsync("audio").then(function (folder) {
            ...
            if (f) {
                ...
                var pritchGroups = [
                    { key: "group1", title: "Притчи обо всем", image: lightGray, description: "Притчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всемПритчи обо всем" },
                ];
                var pritchItems = [];
                for (var i = 0; i != f.size; i = i + 1) {

                    var titleP = ltrim(f[i].name.split('.')[1]);
                    var pritch = {
                        group: pritchGroups[0],
                        title: titleP,
                        song: "audio/" + f[i].name,
                        image: lightGray,
                        textSong: "TextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSong</br>TextSongTextSong</br>TextSongTextSongTextSong</br>TextSongTextSongTex</br>tSongTextSongTextSongText</br>SongTextSongTextSongTextSongTextSongTextSongTextSongTextSongText</br>SongTextSongText</br>SongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSon</br>gTextSongTextSong</br>TextSongTextSongTextSongTextSongTextSongTextSongTextSong</br>TextSongTextSongTextSongTextSongText</br>SongTextSongTextSongTextSongTextSongTextSongTextSong</br>TextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongText</br>SongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSong</br>TextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongTextSongText</br>",
                        articleImage: "images/2.jpg"
                    };
                    //pritchItems.push(pritch);
                    list.push(pritch);
                }
                //saveObjToJSON(pritchItems, "pritchItems.txt");
            }
        });
    }
    ...
    function saveObjToJSON(obj, fileName) {
        ...
        Windows.Storage.KnownFolders.documentsLibrary.createFileAsync(fileName, Windows.Storage.CreationCollisionOption.replaceExisting).done(function (file) {
            Windows.Storage.FileIO.writeTextAsync(file, JSON.stringify(obj));
        });
    }
    ...
    function getPlaylistFromGroup(group) {
        var items = list.createFiltered(function (item) { return item.group.key === group.key; });
        var playlist = [];
        items.forEach(function(item) {
